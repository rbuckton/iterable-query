...
import { Queryable, WritableArrayLike } from "../types";
 ...
 * @category Scalar
 */
export function copyTo<T, U extends WritableArrayLike<T>>(source: Queryable<T>, dest: U, start: number = 0, count: number = dest.length - start): U {
