 ...
 * @category Scalar
 */
export async function maxByAsync<T, K>(source: AsyncQueryable<T>, keySelector: (value: T) => K, keyComparer: Comparison<K> | Comparer<K> = Comparer.defaultComparer): Promise<T | undefined> {
