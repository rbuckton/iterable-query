...
import { assert, ToPossiblyAsyncIterable, ToIterable, ToStringTag, Registry } from "../internal";
 ...
 */
export function scanAsync<T>(source: PossiblyAsyncQueryable<T>, accumulator: (current: T, element: T, offset: number) => T): AsyncIterable<T>;
 ...
 */
export function scanAsync<T, U>(source: PossiblyAsyncQueryable<T>, accumulator: (current: U, element: T, offset: number) => U, seed: U): AsyncIterable<U>;
 ...
 * @param seed An optional seed value.
 */
export function scanAsync<T, U>(source: PossiblyAsyncQueryable<T>, accumulator: (current: T | U, element: T, offset: number) => T | U, seed?: T | U): AsyncIterable<T | U> {
